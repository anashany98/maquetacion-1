...
@section('table')
    ...
    <table>
        ...
        @foreach($stock_categories as $stock_element)
            <tr>
                ...
                <td>
                    <div class="button-container">
                        ...
                        <button class="edit" data-url="{{route('stock_show', ['stock' => $stock_element->id ])}}"> 
...
@section('form')
    ...
    <form class="formulario admin-form" action="{{route("stock_store")}}">
        ...
        <div class="form-group">
            ...
            <div class="input-container">
                <input name="name" type="text" value="{{isset($stock->stock) ? $stock->stock : ''}}" >
            </div>
        </div>
